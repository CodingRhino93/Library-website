...
<body id="home_page">
	...
	<div id="header2">
		...
		<?php
			...
			$_SESSION['counter2'] = $_SESSION['counter2'] - 10;
			$a = $_SESSION['counter2'];
			$loop_end = $a + 5;
...
?>
	...
	<?php 
		...
		if($_SESSION['counter2'] > 5) {
			echo '<p><a class="previous_page_button" href="previous_page.php"><--- Previous Page</a></p>';
		}

	?>
	<p><a id="return_link2" href="home.php">Return to the Home Page</a></p>

	<p><a class="next_page_button" href="next_page.php">Next Page ---></a></p>
